...
class Screen3 extends React.Component {
  ...
  openSettings() {
    ...
    this.state.settingsOpen ? toPos = 0 : toPos = -750
    Animated.spring(
      this.state.pos,
      {
        toValue: toPos,
      ...
      return (
        <View style={{ flex: 1 }}>
          <Camera
            ...
            <Pressable onPress={() => this.openSettings()} style={[styles.buttons, { position: 'absolute', right: 20, top: 500, height: 50, width: 60 }]}><Text style={[styles.text, { fontSize: 30, color: 'white' }]}>⛭</Text></Pressable>
